...
export default function DashboardHome() {
  ...
  if (accounts.length === 0) return (
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100%',padding:'40px'}}>
      <div style={{fontSize:'48px',marginBottom:'20px',fontWeight:'bold'}}>▣</div>
      ...
      <p style={{color:'#444',fontSize:'12px',marginBottom:'32px',fontFamily:'monospace',textAlign:'center'}}>Conecta tus cuentas de Meta Ads para empezar a ver tus métricas</p>
