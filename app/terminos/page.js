...
export const metadata = {
  title: 'Términos de Uso — Reporteador',
}
  ...
  return (
    <div style={{maxWidth:'800px',margin:'0 auto',padding:'60px 24px',fontFamily:'"Plus Jakarta Sans",system-ui,sans-serif',color:'#ccc',lineHeight:'1.8'}}>
      ...
      <section style={{marginBottom:'32px'}}>
        ...
        <p style={{fontSize:'14px'}}>Al usar Reporteador, aceptas estos términos de uso. Si no estás de acuerdo, no uses el servicio.</p>
      </section>

      <section style={{marginBottom:'32px'}}>
        <h2 style={{color:'#fff',fontSize:'18px',fontWeight:'700',marginBottom:'12px'}}>2. Descripción del servicio</h2>
        <p style={{fontSize:'14px'}}>Reporteador es una plataforma de análisis y reporte de campañas de Meta Ads (Facebook e Instagram). Permite a usuarios conectar sus cuentas publicitarias y visualizar métricas de rendimiento.</p>
      </section>
      ...
      <section style={{marginBottom:'32px'}}>
        ...
        <p style={{fontSize:'14px'}}>Reporteador no se hace responsable por decisiones de negocio tomadas basadas en los datos mostrados. Los datos provienen directamente de la API de Meta y pueden tener discrepancias con el Administrador de Anuncios oficial.</p>
      </section>
      ...
      <section style={{marginBottom:'32px'}}>
        ...
        <p style={{fontSize:'14px'}}>Para dudas sobre estos términos: <a href="mailto:legal@reporteador.app" style={{color:'#6366f1'}}>legal@reporteador.app</a></p>
      </section>
    </div>
  )
}
